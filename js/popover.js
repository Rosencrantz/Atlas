 ...
 */
define(['jquery', 'eve', 'settings', 'eventHandlers/controlLifecycle', 'mixins/relativePositionMixin', 'mixins/registerPluginMixin'], function ($, eve, settings, control, positioning, registerPlugin) {
