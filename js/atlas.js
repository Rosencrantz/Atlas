...
define("vendor/require/almond.js", function(){});
 ...
 *
 */
define('eventHandlers/controlLifecycle',['jquery', 'eve', 'settings'], function ($, eve, settings) {
 ...
 *
 */
define('mixins/dispatcher',['jquery', 'eve', 'settings', 'eventHandlers/controlLifecycle'], function ($, eve, settings, control) {
    return {
 ...
 *
 */
define('mixins/relativePosition',['jquery'], function($) {
 ...
 *
 */
define('mixins/register',['jquery'], function ($) {
 ...
 *
 */
define('dropdown',['jquery', 'eve', 'settings',
 ...
 *
 */
define('tab',['jquery', 'settings', 'eventHandlers/controlLifecycle', 'mixins/dispatcher', 'mixins/relativePosition', 'mixins/register'], function ($, settings, control, dispatcher, position, register) {
 ...
 *
 */
define('mixins/navigation',['jquery', 'eve', 'settings', 'eventHandlers/controlLifecycle'], function ($, eve, settings, control) {
 ...
 *
 */
define('mixins/keycodes',['jquery'], function ($) {
      return { 
            BACKSPACE: 8,
            COMMA: 188,
            DELETE: 46,
 ...
 *
 */
define('menu',['jquery', 'eve', 'settings', 'mixins/navigation', 'mixins/keycodes','mixins/register'], function ($, eve, settings, navigation, keycode, register) {
    ...
    $(function () {
        $('[data-' + settings.pluginAttribute + '="' + settings.pluginIdentifier.menu + '"]').each(function () {
            ...
            that.data('nav', nav);
            that.on('keydown keypress', function(event) { 
 ...
 *
 */
define('menubar',['jquery', 'eve', 'settings', 'mixins/navigation', 'mixins/keycodes','mixins/register'], function ($, eve, settings, navigation, keycode, register) {
 ...
 *
 */
define('helptip',['jquery', 'eve', 'settings',
    'eventHandlers/controlLifecycle', 
    'mixins/dispatcher', 
    'mixins/relativePosition', 
    'mixins/register'], 
 ...
 *
 */
define('popover',['jquery', 'eve', 'settings',
    'eventHandlers/controlLifecycle', 
    'mixins/dispatcher', 
    'mixins/relativePosition', 
    'mixins/register'], 
 ...
 *
 */
define('dialog',['jquery', 'eve', 'settings',
    'eventHandlers/controlLifecycle', 
    'mixins/dispatcher', 
    'mixins/relativePosition', 
    'mixins/register'], 
 ...
 *
 */
define('inlinedialog',['jquery', 'eve', 'settings',
    'eventHandlers/controlLifecycle', 
    'mixins/dispatcher', 
    'mixins/relativePosition', 
    'mixins/register'], 
...
define('core',['jquery', 'dropdown', 'tab', 'menu', 'menubar', 'helptip', 'popover', 'dialog', 'inlinedialog'], function ($) {
	$(document).ready(function () {
